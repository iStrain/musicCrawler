...
public class MusicLibrary extends JFrame {
    ...
    public MusicLibrary(String fileName) {
        ...
        frame = new JDialog(null, "Music Library v 0.50",
        ...
        if (loadLibrary()) {
            ...
            text.append(
                    "Loading artist, album and song information from library file: "
                            + this.fileName + ".\n");
            text.append("Loaded " + totalArtists + " artists, " + totalAlbums
                    + " albums and " + totalSongs + " songs from library file: "
                    + this.fileName + ".\n");
            ...
            text.append(
                    "We'll scan your system and create a new library file for you.\n");
            text.append("Scanning for mp3 and wav files.");
            try {
// ADD MP3 BACK IN TO NEXT LINE
            ...
            if (saveLibrary()) {
                text.append("Saved " + numArtists + " artists to library file: "
                        + this.fileName + ".\n");
            }
        }
        text.append(
                "Press the \"OK\" button, or close this window, to see your music.\n");
...
//	bar.setIndeterminate(false);
    ...
    private JSlider createSlider() {
        slider = new JSlider(0, 100,
                text.getBackground().getAlpha() * 100 / 255);
        ...
        slider.addChangeListener(new ChangeListener() {
            public void stateChanged(ChangeEvent e) {
                ...
                text.setBackground(new Color(1.0f, 1.0f, 1.0f,
                        ((float) (source.getValue())) / 100.0f));
            }
        });
        return slider;
    }
    ...
    private JLabel createCopyrightLabel() {
        ...
        cLabel.setFont(
                new Font(f.getFontName(), f.getStyle(), f.getSize() - 2));
        return cLabel;
    }
